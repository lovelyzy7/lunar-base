...
(function () {
  ...
  var ZH = {
    ...
    "missions.completed": "已完成 {{n}} 个任务，耗时 {{s}}s。正在刷新...",
    ...
    "missions.reset_done": "已重置 {{n}} 个任务，耗时 {{s}}s。正在刷新...",
    ...
    "memoir.granted": "已发放 {{name}}：{{n}} 件回忆，耗时 {{s}}s。刷新以更新。",
    ...
    "upgrade.done": "{{label}}：已应用 {{n}} 项，耗时 {{s}}s。刷新以更新数量。",
    ...
    "events.backup_ph": "YYYYMMDD-HHMMSS",
